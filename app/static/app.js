const translations = {
  es: {
    ...
    validation: "AUDITORÍA", validationCopy: "Sets de datos fabricados, detectados y rechazados.", delivery: "ENTREGA", deliveryCopy: "Tu agente listo para ejecutar.",
  ...
  en: {
    ...
    observe: "01 / OBSERVE", video: "VIDEO", observeCopy: "The demonstration becomes structured knowledge.", validation: "AUDIT", validationCopy: "Fabricated datasets caught and refused.",
