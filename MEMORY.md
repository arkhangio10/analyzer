...
- a trustworthy pose or motion measurement pipeline for robot-ready gait extraction. The higher-frame-rate vision-model experiment has now failed its evidence audit twice, on two different subjects and two different kinematic chains (2026-08-30 human walking, 2026-09-07 quadrupedal locomotion). Treat this as a property of asking a vision model for joint angles, not as a bad run to retry;
